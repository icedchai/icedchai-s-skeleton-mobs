...
public class ItemInit {
    ...
    public static final Item SKNIGHT_SPAWN_EGG = new SpawnEggItem(IcedchaisSkeletons.SKNIGHT, 12698049, 4802870, (new FabricItemSettings()).group(MAIN_ITEM_GROUP));
    public static final Item WARCHER_SPAWN_EGG = new SpawnEggItem(IcedchaisSkeletons.WARCHER, 1315860, 4672810, (new FabricItemSettings()).group(MAIN_ITEM_GROUP));
    public static final  Item STKNIGHT_SPAWN_EGG = new SpawnEggItem(IcedchaisSkeletons.STKNIGHT,6387319, 14543540, (new Item.Settings()).group(MAIN_ITEM_GROUP));
